...
export const stageEs = {
  stage: {
    ...
    confirmSwitchMessage: 'Un tema está en progreso. Cambiar de escena finalizará el tema actual. ¿Estás seguro?',
  ...
  whiteboard: {
    ...
    clearError: 'Fallo al limpiar pizarra: ',
    resetView: 'Restablecer vista',
    zoomHint: 'Rueda para zoom · Arrastrar para mover',
    restoreError: 'Fallo al restaurar pizarra: ',
    history: 'Historial',
    restore: 'Restaurar',
    beforeClear: 'Antes de limpiar',
    beforeAIClear: 'Antes de limpiar con IA',
    noHistory: 'Sin historial aún',
    restored: 'Contenido de pizarra restaurado',
    elementCount: '{count} elementos',
  },
  quiz: {
    title: 'Cuestionario',
    subtitle: 'Evalúa tus conocimientos',
    questionsCount: 'preguntas',
    totalPrefix: 'Total: ',
    pointsSuffix: 'pts',
    startQuiz: 'Iniciar cuestionario',
    multipleChoiceHint: '(Pregunta de opción múltiple — selecciona todas las correctas)',
  ...
  pbl: {
    ...
    emptyProject: 'El proyecto PBL aún no se ha generado. Crea uno mediante la generación de curso.',
    roleSelection: {
      title: 'Elige tu rol',
    ...
    workspace: {
      restart: 'Reiniciar',
      confirmRestart: '¿Restablecer todo el progreso?',
      confirm: 'Confirmar',
      cancel: 'Cancelar',
    },
    issueboard: {
    ...
    chat: {
      ...
      send: 'Enviar',
      welcomeMessage:
        '¡Hola! Soy tu asistente de preguntas para esta tarea: «{title}»\n\nPara guiarte en el trabajo, te preparé algunas preguntas orientadoras:\n\n{questions}\n\n¡Puedes @question me en cualquier momento si necesitas ayuda o aclaraciones!',
      issueCompleteMessage: 'Tarea «{completed}» completada. Pasando a la siguiente: «{next}»',
      allCompleteMessage: '🎉 ¡Todas las tareas completadas! ¡Gran trabajo en el proyecto!',
    },
    guide: {
      ...
      title: 'Ayuda',
      step1: {
        title: 'Paso 1: Elegir un rol',
        desc: 'Una vez generado el proyecto, selecciona un rol de la lista (roles no-sistema marcados con 🟢)',
      },
      step2: {
        title: 'Paso 2: Completar tareas',
        desc: 'Cada tarea representa un objetivo de aprendizaje:',
        s1: {
          title: 'Ver tarea actual',
          desc: 'Revisa título, descripción y responsable de la tarea',
        },
        s2: {
          title: 'Obtener orientación',
          example: '@question ¿Por dónde debería empezar?\n@question ¿Cómo implemento esta función?',
          desc: 'El asistente de preguntas te da orientación y pistas (sin dar respuestas directas)',
        },
        s3: {
          title: 'Enviar tu trabajo',
          example: '@judge Ya terminé, por favor revisa mis notas',
          desc: 'El asistente evaluador revisa tu trabajo y da retroalimentación:',
          complete: 'Pasa automáticamente a la siguiente tarea',
          revision: 'Mejora según el feedback',
        },
      },
      step3: {
        title: 'Paso 3: Finalizar el proyecto',
        desc: 'Cuando todas las tareas estén completas, aparecerá «🎉 ¡Proyecto completado!»',
      },
    },
  },
  share: {
